        ...
        <View style={styles.background}>
            <View style={[sty.flexRow, { padding: 2, }]}>
                <View style={[styles.box, { flex: 1 }]}>
                    ...
                    <TextDisplay fontWeight='semibold' fontSize={18} text={userDisplay?.lich_su_don_hang?.total} color={appColor.primary} />
                </View>
                <View style={[styles.box, { flex: 1 }]}>
                    ...
                    <TextDisplay fontWeight='semibold' fontSize={18} text={formatPrice(Number(userDisplay?.thong_ke_doanh_thu?.summary?.tong_doanh_thu) || 0)} color={appColor.primary} />
                </View>
            </View>
        </View>
    )
